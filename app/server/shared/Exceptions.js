...
(function () {
  ...
  module.exports = {
    ...
    ERROR_ACTIVITY_USER_ALREADY_EXISTS: declareNewError('O usuário já foi convidado'),
    ERROR_ACTIVITY_USER_NOT_EXISTS: declareNewError('Usuário não registrado'),
    ERROR_INSERTING_USER: declareNewError('Erro na inserção de usuário'),
